...
MODEL_PATH = "/train/myModel/VLM-R3-main/qwen_vl_finetune/output/0105-output_sft"
...
#     print(f"加载GRPO模型失败: {e}")
#     print("使用原始Qwen2.5-VL模型作为fallback...")
#     ORIGINAL_MODEL_PATH = "/train/myModel/VLM-R3-main/qwen_vl_finetune/output_sft"  # 原始SFT模型
